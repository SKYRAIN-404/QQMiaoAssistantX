    ...
    private void showDisclaimerIfNeeded() {
        try {
            ...
            String msg = "【官方渠道与安全声明】\n\n"
                    + "一、项目来源与版权\n"
                    + "本应用「喵喵助手·夕兮二改版」是基于开源项目「QQ喵喵助手」"
                    + "（QQMiaoAssistant）的二次开发与重构版本。"
                    + "原始「QQ喵喵助手」版权链：\n"
                    + "  原作者（初版）：https://github.com/QiCaiJie114514/QQMiaoAssistant\n"
                    + "  上游仓库：https://github.com/Duckling520-QWQ/QQMiaoAssistant\n"
                    + "  两位上游作者（QiCaiJie114514 与 Duckling520-QWQ）系共同贡献者，已互相取得联系。\n"
                    + "本二改版官方源码仓库：https://github.com/SKYRAIN-404/QQMiaoAssistantX\n"
                    + "原作者及上游作者保留其对原始代码的著作权；"
                    + "本项目全部新增及重构代码由「夕兮 / SKYRAIN」创作，按 AGPLv3 协议发布。\n\n"
                    + "二、唯一官方获取渠道\n"
                    + "本应用唯一官方获取渠道为 QQ：792413814。"
                    ...
                    + "本源：https://github.com/SKYRAIN-404/QQMiaoAssistantX";
            new AlertDialog.Builder(this)
                    .setTitle("官方渠道与安全声明")
                    .setMessage(msg)
                    .setCancelable(false)
