    ...
    private void showDisclaimerIfNeeded() {
        try {
            ...
            String msg = "【官方渠道与安全声明】\n\n"
                    ...
                    + "（QQMiaoAssistant，遵循 AGPLv3 协议）的二次开发与重构版本。"
                    + "原始「QQ喵喵助手」由原作者 Duckling520 开发并开源，"
+ "其官方源码仓库为：\n"
+ "   https://github.com/Duckling520-QWQ/QQMiaoAssistant\n"
+ "原作者 Duckling520 保留其对原始代码的著作权；"
                    ...
                    + "本源：https://github.com/Duckling520-QWQ/QQMiaoAssistant";
            new AlertDialog.Builder(this)
                    .setTitle("官方渠道与安全声明")
                    .setMessage(msg)
                    .setCancelable(false)
